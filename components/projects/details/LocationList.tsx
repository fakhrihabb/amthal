    ...
    <div className="space-y-6">
      ...
      {locations && locations.length > 0 ? (
            ...
            >
              ...
              <div className="flex gap-4">
                ...
                <div className="flex-1 pr-14">
                  <h3 className="font-bold text-lg text-brand-dark mb-1 line-clamp-1">{location.name || "Unnamed Location"}</h3>
        ...
        <div className="text-center py-12 glass-panel rounded-xl border-dashed border-2 border-gray-300/50 bg-slate-50/50">
          ...
          <p className="text-sm text-gray-400 mb-4">Start a new location analysis or add a manual location.</p>
          <button
            onClick={() => setIsModalOpen(true)}
      ...
      <ConfirmationModal
        ...
        message="Are you sure you want to delete this location? Related analysis data will also be permanently deleted."
