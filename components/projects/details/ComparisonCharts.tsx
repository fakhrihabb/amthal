...
export const ComparisonCharts = ({ locations }: ComparisonChartsProps) => {
  ...
  const metrics = [
    ...
    { label: "Access", key: "accessibility_score" },
  ...
  return (
    <div id="comparison-charts-container" className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
      ...
      <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
        <h3 className="text-lg font-bold text-gray-800 mb-4 text-center">Total Score Comparison</h3>
          ...
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={barData} layout="vertical" margin={{ top: 5, right: 30, left: 40, bottom: 5 }}>
              ...
              <Tooltip
                ...
                cursor={{ fill: '#f3f4f6' }}
              />
              <Bar dataKey="score" name="Total Score" radius={[0, 4, 4, 0]} barSize={32} />
            </BarChart>
          </ResponsiveContainer>
        </div>
      </div>
      ...
      <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
        <h3 className="text-lg font-bold text-gray-800 mb-4 text-center">Multi-Dimensional Analysis</h3>
        <div className="h-[300px] w-full">
          <ResponsiveContainer width="100%" height="100%">
        ...
        {locations.length > 5 && (
          <p className="text-center text-xs text-gray-400 mt-2">* Displaying all locations may be confusing</p>
        )}
      </div>
    </div>
  );
