      ...
      <table className="w-full text-sm text-left">
        <thead className="bg-gray-50 text-gray-700 font-semibold border-b border-gray-200">
          <tr>
            ...
            <th className="p-4 text-center hidden md:table-cell">Demand</th>
            <th className="p-4 text-center hidden md:table-cell">Grid</th>
            <th className="p-4 text-center hidden md:table-cell">Access</th>
            <th className="p-4 text-center hidden md:table-cell">Competition</th>
            <th className="p-4 text-center">Status</th>
            <th className="p-4 min-w-[250px]">Notes</th>
          </tr>
        </thead>
        <tbody className="divide-y divide-gray-100">
          {sortedLocations.map((loc) => (
            <tr key={loc.id} className="hover:bg-slate-50 transition-colors">
              <td className="p-4">
                <div className="font-medium text-brand-dark">{loc.name || "Unnamed Location"}</div>
                  ...
                  >
                    {loc.notes ? (
                      ...
                      <span className="text-xs text-gray-400 italic flex items-center gap-1">
                        <AlertCircle className="w-3 h-3" /> Add notes...
                      </span>
                    )}
                  </div>
                )}
